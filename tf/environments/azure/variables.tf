...
variable "azure_resource_group_name" {
  description = "Azure Resource Group name (will be created if create_resource_group is true)"
  type        = string
  default     = ""
}
...
variable "webapi_image" {
  description = "Docker image for WebApi (e.g., REGISTRY.azurecr.io/asptemplate-webapi:latest)"
  type        = string
  default     = ""
}
